...
const Examen: FC = (): JSX.Element => {
  ...
  const dispatch = useAppDispatch();
   ...
   const firstColumnSelectValue = useAppSelector((state) =>
     getColumnData(state, tableNumber, ColumnNumber.firstColumn, 'exam'),
   );
   
   const secondColumnSelectValue = useAppSelector((state) =>
     getColumnData(state, tableNumber, ColumnNumber.secondColumn, 'exam'),
   );
  ...
  return (
    <S.TableRow>
      <S.TableCeil>Экзамен</S.TableCeil>
